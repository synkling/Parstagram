...
//        queryPost();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(MainActivity.this, "Don't forget an image!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String description, ParseUser currUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null)
                {
                    Log.e(TAG, "Post unable to be saved.", e);
                    Toast.makeText(MainActivity.this, "Post unable to be saved.", Toast.LENGTH_SHORT).show();
                }
